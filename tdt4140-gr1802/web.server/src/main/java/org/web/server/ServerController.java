...
//		obj.put("MAXHR", athl.getMaxHR());
	...
	// Maps to GetPass-Endpoint
		@RequestMapping("/getPass")  //check  works
		...
		@RequestMapping("/getAllAthletes")     			//Check  works
		...
		@RequestMapping("/getWorkout") //check   works
...
//			String str = String.join(",", wo.getPulsList());
		...
		@RequestMapping("/getAllWorkouts")  //check     works
		...
		@RequestMapping("/addCoachToAthlete") // needs work
		...
		@RequestMapping("/addAthleteToCoach")  //needs work
		...
		@RequestMapping("/addRequestAthleteToCoach") // needs work
		...
		@RequestMapping("/addRequestCoachToAthlete") // needs work
		...
		@RequestMapping("/getRequestsForCoach") // needs to be implemented
		...
		@RequestMapping("/getRequestsForAthlete") //needs to be implemented
		...
		@RequestMapping("/athleteUsernameExists") // check works
		...
		@RequestMapping("/coachUsernameExists") //check works
		...
		@RequestMapping("/isAthlete") // checko works
		...
		@RequestMapping("/setVisibility") // needs to be implemented 
		...
		@RequestMapping("/getAllActivities") // check works
		...
		@RequestMapping("/getNrWorkoutsForAthlete") //check works
		...
		@RequestMapping("/getAthletesForActivity") //check works
		...
		@RequestMapping("/getWorkoutsForActivity") //check works
		...
		@RequestMapping("/getCoachNotes") //check works
		...
		@RequestMapping("/addCoachNotes") //check works
		...
		@RequestMapping("/updateCoachNotes")  //check wokrs
		...
		@RequestMapping("/createCoach") //needs to be implemented
		...
		@RequestMapping("/createAthlete") // needs to be implemented
		...
		@RequestMapping("/createWorkout") //needs to be implemented
